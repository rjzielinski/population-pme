...
\begin{equation}
  g_{\gamma}(t) = \sum_{i=1}^{T}\delta_i\|t - t_i\|^{3} + \sum_{p=1}^{2}\tau_p \phi(t)_p. \label{eq:7}
\end{equation}
...
\begin{equation}
  f(\mathbf{y}, t) = \sum_{k=1}^{m'}\mathbf{s}_{\gamma}(t)_l \eta_{4-d}\left(\|\mathbf{y} - \mathbf{y'}_k\|\right) + \sum_{p=1}^{d + 1}\mathbf{\alpha}_{\gamma}(t)_p \phi_p(\mathbf{y}). \label{eq:9}
\end{equation}
